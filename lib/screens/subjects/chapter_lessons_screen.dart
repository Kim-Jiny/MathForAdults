      ...
      body: indexAsync.when(
        ...
        data: (index) {
          ...
          return ListView(
            ...
            children: [
              Text('세부 단원을 고르면 난이도를 선택할 수 있어요',
            ...
            child: Column(
              ...
              children: [
                ...
                Flexible(
                  child: ListView(
                    shrinkWrap: true,
                    children: lesson.difficulties.map((d) => Padding(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            ...
                            ref.read(statsProvider.notifier).setContinue(
                                  ContinueInfo(
                                    subject: subjectName,
                                    chapter: chapter,
                                    lesson: lesson.name,
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                DifficultyBadge(d),
                                const Spacer(),
                                Icon(Icons.play_arrow_rounded, color: d.color),
                              ],
                            ),
                          ),
                        ),
